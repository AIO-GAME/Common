...
namespace MonoHook
{
    ...
    {
        /// <summary>
        /// delegate * unmanaged[Cdecl] &lt;void, byte, uint> native_flush_cache_fun_ptr;
        /// </summary>
        /// <remarks>unsupported at C# 8.0</remarks>
        ...
        static HookUtils()
        {
            var p_SystemPageSize = typeof(Environment).GetProperty("SystemPageSize");

...
namespace AIO.UEditor
{
    ...
    /// <summary>
    /// Git Manager AIO Auto Build
    /// </summary>
    [InitializeOnLoad]
    internal static partial class GIT_COM_SELF_BUILD
    {
        internal const string URL = "Packages/com.blz.build";
        internal const string DisplayName = "AIO Auto Build";
        internal const string PackageName = "com.self.build";

        static GIT_COM_SELF_BUILD()
        {
            Refresh();
        }

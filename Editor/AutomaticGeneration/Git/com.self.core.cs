...
namespace AIO.UEditor
{
    ...
    /// <summary>
    /// Git Manager AIO Core
    /// </summary>
    [InitializeOnLoad]
    internal static partial class GIT_COM_SELF_CORE
    {
        internal const string URL = "Packages/com.blz.core";
        internal const string DisplayName = "AIO Core";
        internal const string PackageName = "com.self.core";

        static GIT_COM_SELF_CORE()
        {
            Refresh();
        }

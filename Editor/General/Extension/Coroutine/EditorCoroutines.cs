...
namespace AIO.UEditor
{
    public class EditorCoroutines
    {
        ...
        private Dictionary<string, List<EditorCoroutine>> coroutineDict =
        ...
        public static EditorCoroutine StartCoroutine(string methodName, object value, object thisReference)
        {
            ...
            var returnValue = methodInfo.Invoke(thisReference, value == null
                ? null
                : new object[] { value });
        ...
        private static object GetInstanceField(Type type, object obj, string fieldName)
        {
            const BindingFlags bindFlags = BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic |
                                           BindingFlags.Static;
            return type.GetField(fieldName, bindFlags)?.GetValue(obj);
        }
    }
}
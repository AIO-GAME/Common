...
namespace AIO.UEditor
{
    ...
    public partial class GELayout 
    {
        ...
        /// <param name="label">标题 <see cref="string"/></param>
        /// <param name="value">值 <see cref="int"/></param>
        /// <param name="displayedOptions">弹窗内容 <see cref="GUIContent[]"/></param>
        /// <param name="optionValues">排版格式 <see cref="int[]"/></param>
        /// <param name="options">格式参数 <see cref="GUILayoutOption"/></param>
        /// <returns><see cref="int"/></returns>
        ...
        /// <param name="label">标题 <see cref="string"/></param>
        /// <param name="value">值 <see cref="int"/></param>
        /// <param name="displayedOptions">弹窗内容 <see cref="string[]"/></param>
        /// <param name="optionValues">排版格式 <see cref="int[]"/></param>
        /// <param name="options">格式参数 <see cref="GUILayoutOption"/></param>
        /// <returns><see cref="int"/></returns>
        ...
        /// <param name="label">标题 <see cref="string"/></param>
        /// <param name="value">值 <see cref="int"/></param>
        /// <param name="displayedOptions">弹窗内容 <see cref="int[]"/></param>
        /// <param name="optionValues">排版格式 <see cref="int[]"/></param>
        /// <param name="options">格式参数 <see cref="GUILayoutOption"/></param>
        /// <returns><see cref="int"/></returns>

    ...
    public static partial class GT
    {
        ...
        public static class BE
        {
            ...
            public static void ChangeCheck(Action action)
            {
                ...
                EditorGUI.BeginChangeCheck(); action(); EditorGUI.EndChangeCheck();
            }
            ...
            {
                if (action == null) return;
                EditorGUI.BeginProperty(rect, label, property); action(); EditorGUI.EndProperty();
            }
            ...
            {
                if (action == null) return;
                EditorGUI.BeginProperty(rect, new GUIContent(label), property); action(); EditorGUI.EndProperty();
            }
            ...
            {
                if (action == null) return;
                EditorGUI.BeginDisabledGroup(disable); action(); EditorGUI.EndChangeCheck();
            }
                 ...
                 GUIStyle style = null, Action<Rect> menuAction = null, GUIStyle menuIcon = null)
            {
                ...
                action(); EditorGUI.EndFoldoutHeaderGroup(); return b;
            }
...
#endif
                var b = EditorGUI.BeginFoldoutHeaderGroup(rect, flodout, content, style, menuAction, menuIcon);
                action(); EditorGUI.EndFoldoutHeaderGroup();
                return b;
            }

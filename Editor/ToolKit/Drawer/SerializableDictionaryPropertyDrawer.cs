...
//         static readonly GUIContent s_warningIconConflict = IconContent("console.warnicon.sml", "Conflicting key, this entry will be lost");
//         static readonly GUIContent s_warningIconOther = IconContent("console.infoicon.sml", "Conflicting key");
//         static readonly GUIContent s_warningIconNull = IconContent("console.warnicon.sml", "Null key, this entry will be lost");
...
//         }
//
//         static readonly Dictionary<PropertyIdentity, ConflictState> s_conflictStateDict = new Dictionary<PropertyIdentity, ConflictState>();
//
//         enum Action
//         {
//             None,
...
//             if (property.isExpanded) labelPosition.xMax -= s_buttonStyle.CalcSize(s_iconPlus).x;
//
...
//                 if (valueArrayProperty != null) DeleteArrayElementAtIndex(valueArrayProperty, buttonActionIndex);
//             }
//
...
//             else return Equals(value1, value2);
//         }
//
...
//                 if (!dict2.TryGetValue(key1, out object value2)) return false;

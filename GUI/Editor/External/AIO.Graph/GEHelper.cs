...
namespace AIO.UEditor
{
    public static class GEHelper
    {
        ...
        public static Rect GetControlRect(bool hasLabel, float height, GUIStyle style, params GUILayoutOption[] options) { return EditorGUILayout.GetControlRect(hasLabel, height, style, options); }
        ...
        /// <param name="height">控件的高度(以像素为单位)</param>
        /// <param name="options">排版格式</param>
        public static Rect GetControlRect(bool hasLabel, float height, params GUILayoutOption[] options) { return EditorGUILayout.GetControlRect(hasLabel, height, options); }
        ...
        /// <returns>用户选择的折叠状态</returns>
        public static bool InspectorTitlebar(bool foldout, Object targetObj, bool expandable) { return EditorGUILayout.InspectorTitlebar(foldout, targetObj, expandable); }
        ...
        /// <param name="expandable">是否允许打开</param>
        /// <returns>用户选择的折叠状态</returns>
        public static bool InspectorTitlebar(bool foldout, Object[] targetObjs, bool expandable) { return EditorGUILayout.InspectorTitlebar(foldout, targetObjs, expandable); }
        ...
        private static readonly Lazy<MethodInfo> AddMenuItemMethod = new Lazy<MethodInfo>(() =>
        {
            var assembly = typeof(EditorApplication).Assembly;
            var menuType = assembly.GetType("UnityEditor.Menu");
            return menuType.GetMethod("AddMenuItem", BindingFlags.Static | BindingFlags.NonPublic);
        });

        /// <summary>
        /// 添加菜单项
        /// </summary>
        /// <param name="name"> 菜单路径 </param>
        ...
        {
            AddMenuItemMethod.Value.Invoke(null, new object[]
            {
                name,     // 菜单路径
                shortcut, // 快捷键
                @checked, // validate

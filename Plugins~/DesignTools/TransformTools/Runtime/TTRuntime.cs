...
namespace PluginMaster.Runtime
{
    public static class TTRuntime
    {
        ...
        private static Bounds GetSelectionBounds(GameObject[] selection, bool recursive = true)
        {
        ...
        {
            if (selection.Length < 2 || selection.Length > data.x.cells * data.y.cells * data.z.cells) return false;
            ...
            if (data.x.overwrite)
            {
                ...
                for (int i = 0; i < data.x.cells; ++i)
                {
                    ...
                    Align(objList.ToArray(), RelativeTo.SELECTION, Axis.X, data.x.aligment, false);
                    var columnBounds = GetSelectionBounds(objList.ToArray(), RelativeTo.SELECTION, Axis.X).Item2;
                    ...
                    columnBounds = GetSelectionBounds(objList.ToArray(), RelativeTo.SELECTION, Axis.X).Item2;
                    ...
                    else prevMaxX = columnBounds.max.x;
                }
            }
            ///// Y
            if (data.y.overwrite)
            {
                ...
                for (int j = 0; j < data.y.cells; ++j)
                {
                    ...
                    Align(objList.ToArray(), RelativeTo.SELECTION, Axis.Y, data.y.aligment, false);
                    var rowBounds = GetSelectionBounds(objList.ToArray(), RelativeTo.SELECTION, Axis.Y).Item2;
                    ...
                    rowBounds = GetSelectionBounds(objList.ToArray(), RelativeTo.SELECTION, Axis.Y).Item2;
            ...
            if (data.z.overwrite)
            {
                ...
                for (int k = 0; k < data.z.cells; ++k)
                {
                    ...
                    Align(objList.ToArray(), RelativeTo.SELECTION, Axis.Z, data.z.aligment, false);
                    var columnBounds = GetSelectionBounds(objList.ToArray(), RelativeTo.SELECTION, Axis.Z).Item2;
                    ...
                    columnBounds = GetSelectionBounds(objList.ToArray(), RelativeTo.SELECTION, Axis.Z).Item2;
                    ...
                    else prevMaxZ = columnBounds.max.z;
                }
            }
            return true;
        }
        ...
        public static void PlaceOnSurface(GameObject[] selection, PlaceOnSurfaceData data)
        {
            ...
            foreach (var obj in selection) PlaceOnSurface(obj.transform, data, null);

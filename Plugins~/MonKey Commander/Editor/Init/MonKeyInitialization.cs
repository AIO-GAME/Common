...
{
    public static readonly string MonKeyVersion = "2020.1.6";

    private const string defaultDLLInstallPath = "Assets/Plugins/" +
    ...
    {
        EnsureGoodDll();
        MonKeySettingsEditor.InitSettings();
    ...
    private static void EnsureGoodDll()
    {
       ...
       currentVersion = "2017";
        ...
        currentVersion = "2017"
#endif
        var dll = AssetDatabase.LoadAssetAtPath<Object>(defaultDLLInstallPath + currentVersion + "/MonKey Commander." + currentVersion);

...
public class FairyGUI_EventListenerWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("GetEventCallback0", GetEventCallback0);
		L.RegFunction("GetEventCallback1", GetEventCallback1);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetEventCallback0(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			FairyGUI.EventListener obj = (FairyGUI.EventListener)ToLua.CheckObject<FairyGUI.EventListener>(L, 1);
			FairyGUI.EventCallback0 o = obj.GetEventCallback0();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int GetEventCallback1(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			FairyGUI.EventListener obj = (FairyGUI.EventListener)ToLua.CheckObject<FairyGUI.EventListener>(L, 1);
			FairyGUI.EventCallback1 o = obj.GetEventCallback1();
			ToLua.Push(L, o);
			return 1;
		}
		catch (Exception e)

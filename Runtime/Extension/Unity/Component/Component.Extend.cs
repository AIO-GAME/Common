...
namespace AIO.UEngine
{
    ...
    {
        public static void DestroyAllChildes<T>(this T component) where T : Component
        {
        ...
        public static void SetLayer<T>(this T component, in int layer) where T : Component
        {
            component.gameObject.layer = layer;
        }

        public static void SetLayer<T>(this T component, in Enum layer) where T : Component
        {
            component.gameObject.layer = layer.GetHashCode();
        }

        public static void SetLayerAll<T>(this T component, in int layer) where T : Component
        {
            component.gameObject.layer = layer;
        ...
        public static void SetLayerAll<T>(this T component, in Enum layer) where T : Component
        {
        ...
        public static void SetLayerChildes<T>(this T component, in int layer) where T : Component
        {
            var children = component.GetComponentsInChildren<Transform>(true);
            if (children == null || children.Length == 0) return;
            foreach (var child in children) child.gameObject.layer = layer;
        ...
        public static void SetLayerChildes<T>(this T component, in Enum layer) where T : Component
        {
            var children = component.GetComponentsInChildren<Transform>(true);
        ...
        public static void SetTag<T>(this T trans, in string tag) where T : Component
        {
            trans.tag = tag;
        }

        public static void SetTagAll<T>(this T trans, in string tag) where T : Component
        {
            trans.tag = tag;
        ...
        public static void SetTagChildes<T>(this T trans, in string tag) where T : Component
        {
            foreach (Transform item in trans.transform)
            {
                item.tag = tag;
        ...
        public static T GetComponentInParent<T>(this T component, in bool includeInactive) where T : Component
        {

...
namespace AIO.UEngine
{
    ...
    public static partial class GameObjectExtend
    {
        ...
        public static T AddChildNodeComponent<T>(this GameObject obj, in string childName)
        where T : Component
        {
            //查找特定节点结果  查找特定子节点
        ...
        public static void Destroy<T>(this T obj, in float tiems)
        where T : Object
        {
#if UNITY_EDITOR
        ...
        public static T Clone<T>(this T obj, in Transform trans)
        where T : Object
        {

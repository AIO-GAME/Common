...
namespace AIO.UEngine
{
    ...
    internal partial class YAssetSystem
    {
        ...
        public static IEnumerator LoadSubAssetsDefaultCO<TObject>(string location, Action<TObject[]> cb) where TObject : Object
        {
        ...
        /// <param name="location">资源的定位地址</param>
        /// <param name="cb">回调</param>
        public static IEnumerator LoadAssetDefaultCO<TObject>(string location, Action<TObject> cb) where TObject : Object
        {

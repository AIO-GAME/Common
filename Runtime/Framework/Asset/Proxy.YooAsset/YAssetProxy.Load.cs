...
namespace AIO.UEngine
{
    public partial class YAssetProxy
    {
        ...
        public override IEnumerator LoadSceneCO(string location, Action<Scene> cb, LoadSceneMode sceneMode = LoadSceneMode.Single, bool suspendLoad = false, int priority = 100)
        {

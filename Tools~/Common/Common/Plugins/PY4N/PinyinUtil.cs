...
using static AIO.PY4N.PinyinFormat;
...
namespace AIO.PY4N
{
    ...
    public static class PinyinUtil
    {
        ...
        /// <returns></returns>
        public static bool IsChinese(char ch) { return 0x4e00 <= ch && ch <= 0x9fbb; }
        ...
        /// <returns></returns>
        public static PinyinFormat ParseFormat(string str) { return Enum.TryParse(str, out PinyinFormat format) ? format : None; }
        ...
        /// <returns></returns>
        public static bool Contains(this PinyinFormat value, PinyinFormat expected) { return (expected & value) == expected; }

...
//     [Serializable]
//     public class PooledDictionary<TKey, TValue> : IDictionary<TKey, TValue>, IDictionary,
...
//             HashSizeName = "HashSize"; // Do not rename (binary serialization). Must save buckets.Length
//
...
//         /// Creates a new instance of PooledDictionary.
//         /// </summary>
//         public PooledDictionary(int capacity, IEqualityComparer<TKey> comparer) : this(capacity, ClearMode.Auto,
//             comparer)
//         {
//         }
//
...
//         /// Creates a new instance of PooledDictionary.
//         /// </summary>
//         public PooledDictionary(IDictionary<TKey, TValue> dictionary, ClearMode clearMode) : this(dictionary, clearMode,
//             null)
//         {
//         }
//
...
//             dictionary, ClearMode.Auto, comparer)
//         {
//         }
//
//         /// <summary>
...
//             : this(array, ClearMode.Auto, null)
//         {
//         }
//
//         /// <summary>
...
//             : this(array, ClearMode.Auto, comparer)
//         {
//         }
//
//         /// <summary>
...
//             : this(array.Length, clearMode, comparer)
//         {
...
//         /// Creates a new instance of PooledDictionary.
//         /// </summary>
//         public PooledDictionary(ICollection<(TKey key, TValue value)> span)
...
//         /// Creates a new instance of PooledDictionary.
//         /// </summary>
//         public PooledDictionary(ICollection<(TKey key, TValue value)> span, ClearMode clearMode)
...
//         /// Creates a new instance of PooledDictionary.
//         /// </summary>
//         public PooledDictionary(ICollection<(TKey key, TValue value)> span, IEqualityComparer<TKey> comparer)
...
//         public PooledDictionary(ICollection<(TKey key, TValue value)> span, ClearMode clearMode,
//             IEqualityComparer<TKey> comparer)
//             : this(span.Count, clearMode, comparer)
//         {
...
//         }
//
//         public void AddRange(ICollection<(TKey key, TValue value)> span)
//         {
//             EnsureCapacity(_count + span.Count);
//
//             foreach (var (key, value) in span)
//             {
//                 TryInsert(key, value, InsertionBehavior.ThrowOnExisting);
...
//                     {
//                         if (entries[i].hashCode >= 0 &&
//                             EqualityComparer<TValue>.Default.Equals(entries[i].value, value)) return true;
//                     }
//                 }
//                 else
//                 {
...
//                         if ((uint)i >= (uint)length || (entries[i].hashCode == hashCode &&

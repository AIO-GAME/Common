...
//         /// before any reallocations are required.
//         /// </summary>
//         /// <param name="customPool">The pool to use for array allocation.</param>
...
//         /// <param name="clearMode">The clear mode to use when returning arrays to the pool.</param>
...
//         /// given collection.
//         /// </summary>
//         public PooledList(T[] array) : this(array, ClearMode.Auto, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// given collection.
//         /// </summary>
//         public PooledList(T[] array, ClearMode clearMode) : this(array, clearMode, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// given collection.
//         /// </summary>
//         public PooledList(T[] array, ArrayPool<T> customPool) : this(array, ClearMode.Auto, customPool)
//         {
//         }
//
//         /// <summary>
...
//         /// given collection.
//         /// </summary>
//         public PooledList(IReadOnlyCollection<T> span) : this(span, ClearMode.Auto, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// given collection.
//         /// </summary>
//         public PooledList(IReadOnlyList<T> span, ClearMode clearMode) : this(span, clearMode, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// given collection.
//         /// </summary>
//         public PooledList(IReadOnlyList<T> span, ArrayPool<T> customPool) : this(span, ClearMode.Auto, customPool)
//         {
//         }
//
//         /// <summary>
...
//         /// given collection.
//         /// </summary>
//         public PooledList(IReadOnlyList<T> span, ClearMode clearMode, ArrayPool<T> customPool)
//         {
//             _pool = customPool ?? ArrayPool<T>.Shared;
//             _clearOnFree = ShouldClear(clearMode);
//
...
//             {
//                 _items = _pool.Rent(count);
//                 Array.Copy(span.ToArray(), _items, count);
//                 _size = count;
//             }
//         }
//
...
//
//         /// <summary>
//         /// Gets a <see cref="IList{T}"/> for the items currently in the collection.
//         /// </summary>
//         public T[] Span => _items;
//
//         /// <inheritdoc/>
//         IReadOnlyList<T> IReadOnlyPooledList<T>.Span => Span;
//
//         /// <summary>
...
//         {
//             var newSpan = InsertSpan(_size, array.Length, false);
//             array.CopyTo(newSpan.ToArray(), 0);
//         }
//
//         /// <summary>
...
//         /// capacity or the new size, whichever is larger.
//         /// </summary>
//         public void AddRange(IReadOnlyList<T> span)
//         {
//             var newSpan = InsertSpan(_size, span.Count, false);
//             Array.Copy(span.ToArray(), 0, newSpan.ToArray(), 0, span.Count);
//         }
//
//         /// <summary>
...
//         public IList<T> AddSpan(int count)
...
//         /// to the end of the list by setting index to the List's size.
//         /// </summary>
//         public void InsertRange(int index, IReadOnlyList<T> span)
//         {
//             var newSpan = InsertSpan(index, span.Count, false);
//             Array.Copy(span.ToArray(), 0, newSpan.ToArray(), 0, span.Count);
//         }
//
//         /// <summary>
...
//             Array.Copy(array, 0, InsertSpan(index, array.Length, false).ToArray(), 0, array.Length);
//         }
//
//         /// <summary>
//         /// Advances the <see cref="Count"/> by the number of items specified,
...
//         /// of the collection.
//         /// </summary>
//         public IList<T> InsertSpan(int index, int count)
//             => InsertSpan(index, count, true);
//
//         private IList<T> InsertSpan(int index, int count, bool clearOutput)
//         {
//             EnsureCapacity(_size + count);
//
//             if (index < _size)

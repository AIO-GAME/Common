...
//         /// collection and has sufficient capacity to accommodate the number of elements copied.
//         /// </summary>
//         public PooledQueue(IEnumerable<T> enumerable, ClearMode clearMode) : this(enumerable, clearMode,
//             ArrayPool<T>.Shared)
//         {
//         }
//
...
//         /// collection and has sufficient capacity to accommodate the number of elements copied.
//         /// </summary>
//         public PooledQueue(IEnumerable<T> enumerable, ArrayPool<T> customPool) : this(enumerable, ClearMode.Auto,
//             customPool)
//         {
//         }
//
...
//         /// </summary>
//         public PooledQueue(T[] array) : this(array, ClearMode.Auto, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// array and has sufficient capacity to accommodate the number of elements copied.
//         /// </summary>
//         public PooledQueue(T[] array, ClearMode clearMode) : this(array, clearMode, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// array and has sufficient capacity to accommodate the number of elements copied.
//         /// </summary>
//         public PooledQueue(T[] array, ArrayPool<T> customPool) : this(array, ClearMode.Auto, customPool)
//         {
//         }
//
//         /// <summary>
...
//             _pool = customPool ?? ArrayPool<T>.Shared;
//             _clearOnFree = ShouldClear(clearMode);
//             _array = _pool.Rent(array.Length);
//             array.CopyTo(_array);
//             _size = array.Length;
//             if (_size != _array.Length) _tail = _size;
//         }
...
//         /// </summary>
//         public PooledQueue(IReadOnlyList<T> span) : this(span, ClearMode.Auto, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// span and has sufficient capacity to accommodate the number of elements copied.
//         /// </summary>
//         public PooledQueue(IReadOnlyList<T> span, ClearMode clearMode) : this(span, clearMode, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// span and has sufficient capacity to accommodate the number of elements copied.
//         /// </summary>
//         public PooledQueue(IReadOnlyList<T> span, ArrayPool<T> customPool) : this(span, ClearMode.Auto, customPool)
//         {
//         }
//
//         /// <summary>
...
//         /// span and has sufficient capacity to accommodate the number of elements copied.
//         /// </summary>
//         public PooledQueue(IReadOnlyList<T> span, ClearMode clearMode, ArrayPool<T> customPool)
//         {
//             _pool = customPool ?? ArrayPool<T>.Shared;
//             _clearOnFree = ShouldClear(clearMode);
//             _array = _pool.Rent(span.Count);
//             Array.Copy(span.ToArray(), _array, span.Count);
//             _size = span.Count;
//             if (_size != _array.Length) _tail = _size;
//         }
//

...
//                 collection is PooledSet<T> ps ? ps.Comparer :
//                 collection is HashSet<T> hs ? hs.Comparer : EqualityComparer<T>.Default)
//         {
//         }
//
//         /// <summary>
...
//         /// </summary>
//         public PooledSet(IEnumerable<T> collection, ClearMode clearMode, IEqualityComparer<T> comparer) : this(
//             clearMode, comparer)
//         {
//             if (collection == null)
//             {
...
//         /// Creates a new instance of PooledSet.
//         /// </summary>
//         public PooledSet(T[] array, ClearMode clearMode) : this(array, clearMode, null)
//         {
//         }
//
//         /// <summary>
//         /// Creates a new instance of PooledSet.
//         /// </summary>
//         public PooledSet(T[] array, IEqualityComparer<T> comparer) : this(array, ClearMode.Auto, comparer)
//         {
//         }
//
//         /// <summary>
//         /// Creates a new instance of PooledSet.
//         /// </summary>
//         public PooledSet(T[] array, ClearMode clearMode = ClearMode.Auto, IEqualityComparer<T> comparer = null) : this(
//             clearMode, comparer)
//         {
//             // to avoid excess resizes, first set size based on collection's count. Collection
//             // may contain duplicates, so call TrimExcess if resulting hashset is larger than
...
//         /// Creates a new instance of PooledSet.
//         /// </summary>
//         public PooledSet(ICollection<T> span, ClearMode clearMode) : this(span, clearMode, null)
//         {
//         }
//
//         /// <summary>
//         /// Creates a new instance of PooledSet.
//         /// </summary>
//         public PooledSet(ICollection<T> span, IEqualityComparer<T> comparer) : this(span, ClearMode.Auto, comparer)
//         {
//         }
//
//         /// <summary>
//         /// Creates a new instance of PooledSet.
//         /// </summary>
//         public PooledSet(ICollection<T> span, ClearMode clearMode = ClearMode.Auto,
//             IEqualityComparer<T> comparer = null) : this(clearMode,
//             comparer)
//         {
//             // to avoid excess resizes, first set size based on collection's count. Collection
//             // may contain duplicates, so call TrimExcess if resulting hashset is larger than
//             // threshold
//             Initialize(span.Count);
//
//             UnionWith(span);
//
//             if (_count > 0 && _size / _count > ShrinkThreshold)
...
//         {
//             for (int i = 0, len = other.Count; i < len; i++)
//             {
...
//         /// </remarks>
//         /// <param name="other">enumerable with items to add </param>
//         public void IntersectWith(T[] other) => IntersectWith((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Takes the intersection of this set with other. Modifies this set.
//         /// </summary>
...
//         /// </summary>
//         /// <param name="other">enumerable with items to remove</param>
//         public void ExceptWith(T[] other) => ExceptWith((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Remove items in other from this set. Modifies this set.
//         /// </summary>
...
//         public void SymmetricExceptWith(T[] other) => SymmetricExceptWith((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Takes symmetric difference (XOR) with other and this set. Modifies this set.
//         /// </summary>
//         /// <param name="other">span with items to XOR</param>
//         public void SymmetricExceptWith(IReadOnlyList<T> other)
//         {
//             // if set is empty, then symmetric difference is other
//             if (_count == 0)
//             {
...
//         /// <param name="other"></param>
//         /// <returns>true if this is a subset of other; false if not</returns>
//         public bool IsSubsetOf(T[] other) => IsSubsetOf((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Checks if this is a subset of other.
//         /// </summary>
//         /// <param name="other"></param>
//         /// <returns>true if this is a subset of other; false if not</returns>
//         public bool IsSubsetOf(IReadOnlyList<T> other)
//         {
//             // The empty set is a subset of any set
//             if (_count == 0)
//             {
...
//         /// <param name="other"></param>
//         /// <returns>true if this is a proper subset of other; false if not</returns>
//         public bool IsProperSubsetOf(T[] other) => IsProperSubsetOf((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Checks if this is a proper subset of other (i.e. strictly contained in)
//         /// </summary>
...
//         /// <param name="other"></param>
//         /// <returns>true if this is a proper subset of other; false if not</returns>
//         public bool IsProperSubsetOf(IReadOnlyList<T> other)
//         {
//             // no set is a proper subset of an empty set
//             if (other.Count == 0)
//             {
...
//         /// <param name="other"></param>
//         /// <returns>true if this is a superset of other; false if not</returns>
//         public bool IsSupersetOf(T[] other) => IsSupersetOf((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Checks if this is a superset of other
//         /// </summary>
...
//         /// <param name="other"></param>
//         /// <returns>true if this is a superset of other; false if not</returns>
//         public bool IsSupersetOf(IReadOnlyList<T> other)
//         {
//             // if other is the empty set then this is a superset
//             if (other.Count == 0)
//             {
...
//         /// <param name="other"></param>
//         /// <returns>true if this is a proper superset of other; false if not</returns>
//         public bool IsProperSupersetOf(T[] other) => IsProperSupersetOf((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Checks if this is a proper superset of other (i.e. other strictly contained in this)
//         /// </summary>
...
//         /// <param name="other"></param>
//         /// <returns>true if this is a proper superset of other; false if not</returns>
//         public bool IsProperSupersetOf(IReadOnlyList<T> other)
//         {
//             // the empty set isn't a proper superset of any set.
//             if (_count == 0)
//             {
...
//         /// <param name="other"></param>
//         /// <returns>true if these have at least one common element; false if disjoint</returns>
//         public bool Overlaps(T[] other) => Overlaps((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Checks if this set overlaps other (i.e. they share at least one item)
//         /// </summary>
//         /// <param name="other"></param>
//         /// <returns>true if these have at least one common element; false if disjoint</returns>
//         public bool Overlaps(IReadOnlyList<T> other)
//         {
//             if (_count == 0)
//             {
//                 return false;
...
//         /// <param name="other"></param>
//         /// <returns></returns>
//         public bool SetEquals(T[] other) => SetEquals((IReadOnlyList<T>)other);
//
//         /// <summary>
//         /// Checks if this and other contain the same elements. This is set equality: 
//         /// duplicates and order are ignored
...
//         /// <param name="other"></param>
//         /// <returns></returns>
//         public bool SetEquals(IReadOnlyList<T> other)
//         {
//             // if this count is 0 but other contains at least one element, they can't be equal
//             if (_count == 0 && other.Count > 0)
//             {
//                 return false;
//             }
//
...
//         /// </summary>
//         public void CopyTo(IList<T> span) => CopyTo(span, _count);
//
//         /// <summary>
//         /// Copies <paramref name="count"/> items from the set to the given span.
//         /// </summary>
//         public void CopyTo(IList<T> span, int count)
//         {
//             if (span.Count < _count || span.Count < count)
//             {
...
//         /// <param name="other"></param>
//         /// <returns></returns>
//         private bool ContainsAllElements(IReadOnlyList<T> other)
//         {
//             foreach (T element in other)
//             {
//                 if (!Contains(element))
...
//
//             var span = stackalloc int[StackAllocThreshold];
//             var bitHelper = intArrayLength <= StackAllocThreshold
//                 ? new BitHelper(ExtendISpan.Slice(span, 0, intArrayLength), clear: true)
...
//         /// </summary>
//         /// <param name="other"></param>
//         private unsafe void IntersectWithSpan(IReadOnlyList<T> other)
//         {
//             Debug.Assert(_buckets != null, "_buckets shouldn't be null; callers should check first");
//
//             // keep track of current last index; don't want to move past the end of our bit array
...
//             var intArrayLength = BitHelper.ToIntArrayLength(originalLastIndex);
//
//             var itemsToRemoveSpan = stackalloc int[StackAllocThreshold / 2];
//             var itemsToRemove = intArrayLength <= StackAllocThreshold / 2
//                 ? new BitHelper(ExtendISpan.Slice(itemsToRemoveSpan, 0, intArrayLength), clear: true)
//                 : new BitHelper(new int[intArrayLength], clear: false);
//
//             var itemsAddedFromOtherSpan = stackalloc int[StackAllocThreshold / 2];
//             var itemsAddedFromOther = intArrayLength <= StackAllocThreshold / 2
//                 ? new BitHelper(ExtendISpan.Slice(itemsAddedFromOtherSpan, 0, intArrayLength), clear: true)
//                 : new BitHelper(new int[intArrayLength], clear: false);
//
//             foreach (var item in other)
//             {
...
//             for (var i = itemsToRemove.FindFirstMarked();
//                  i < originalLastIndex;
//                  i = itemsToRemove.FindFirstMarked(i + 1))
//             {
//                 if (_slots[i].hashCode >= 0) Remove(_slots[i].value);
//             }
//         }
...
//         /// </summary>
//         /// <param name="other"></param>
//         private unsafe void SymmetricExceptWithSpan(IReadOnlyList<T> other)
//         {
//             var originalLastIndex = _lastIndex;
//             var intArrayLength = BitHelper.ToIntArrayLength(originalLastIndex);
//
...
//         /// because unfoundCount must be 0.</param>
//         /// <returns></returns>
//         private ElementCount CheckUniqueAndUnfoundElements(IReadOnlyList<T> other, bool returnIfUnfound)
//         {
//             ElementCount result;
//
//             // need special case in case this has no elements. 

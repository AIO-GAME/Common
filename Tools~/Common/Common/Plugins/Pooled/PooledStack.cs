...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(IEnumerable<T> enumerable, ClearMode clearMode) : this(enumerable, clearMode,
//             ArrayPool<T>.Shared)
//         {
//         }
//
...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(IEnumerable<T> enumerable, ArrayPool<T> customPool) : this(enumerable, ClearMode.Auto,
//             customPool)
//         {
//         }
//
...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(T[] array) : this(array, ClearMode.Auto, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(T[] array, ClearMode clearMode) : this(array, clearMode, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(T[] array, ArrayPool<T> customPool) : this(array, ClearMode.Auto, customPool)
//         {
//         }
//
//         /// <summary>
...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(IReadOnlyCollection<T> span) : this(span, ClearMode.Auto, ArrayPool<T>.Shared)
//         {
//         }
//
//         /// <summary>
...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(IReadOnlyCollection<T> span, ClearMode clearMode) : this(span, clearMode,
//             ArrayPool<T>.Shared)
//         {
//         }
//
...
//         /// pushed onto the stack in the same order they are read by the enumerator.
//         /// </summary>
//         public PooledStack(IReadOnlyCollection<T> span, ArrayPool<T> customPool) : this(span, ClearMode.Auto,
//             customPool)
//         {
//         }
//
...
//         }
//
//         public void CopyTo(IList<T> span)
//         {
//             if (span.Count < _size)
//             {

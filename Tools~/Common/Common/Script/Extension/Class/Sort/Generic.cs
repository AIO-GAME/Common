...
namespace AIO
{
    partial class ExtendSort
    {
        ...
        public static IList<T> Sort<T>(this IList<T> array, in ESort sort = ESort.Quick) where T : IComparable
        {
        ...
        public static IList<T> Sort<T>(
            ...
            in ESort sort = ESort.Quick) where T : IComparable
        {
            if (array is null) throw new ArgumentNullException(nameof(array));
            if (array.Count <= 1) return array;
            return sort switch
        ...
        /// <exception cref="ArgumentOutOfRangeException">传入的排序方式不在枚举内</exception>
        /// <exception cref="ArgumentNullException">传入的数组为空</exception>
        public static T[] Sort<T>(this T[] array, in ESort sort = ESort.Quick) where T : IComparable
        {
            if (array is null) throw new ArgumentNullException(nameof(array));

...
namespace AIO
{
    public static partial class ExtendSort
    {
        ...
        /// 桶排序
        /// </summary>
        public static IList<int> SortBucket(this IList<int> array)
        {
        ...
        /// 基数排序
        /// </summary>
        public static IList<int> SortRadix(this IList<int> array)
        {
            if (array.Count < 2) return array;
        ...
        /// 计数排序
        /// </summary>
        public static IList<int> SortCounting(this IList<int> array)
        {

...
namespace AIO.FMach
{
    ...
    public sealed class TSMath
    {
        ...
        **/
        ...
        public static FP Sqrt(FP number) { return FP.Sqrt(number); }
        ...
        public static FP Max(FP val1, FP val2) { return (val1 > val2) ? val1 : val2; }
        ...
        public static FP Min(FP val1, FP val2) { return (val1 < val2) ? val1 : val2; }
        ...
        /// </summary>
        public static FP Abs(FP value) { return FP.Abs(value); }
        ...
        /// The argument was non-positive
        /// </exception>
        public static FP Ln(FP x) { return FP.FastMul(Log2(x), FP.Ln2); }

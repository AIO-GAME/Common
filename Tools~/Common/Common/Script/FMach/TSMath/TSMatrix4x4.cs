...
namespace AIO.FMach
{
    ...
    public struct TSMatrix4x4
    {
        ...
        public FP Trace() { return this.M11 + this.M22 + this.M33 + this.M44; }
        ...
        public static TSMatrix4x4 Translate(TSVector translation) { return Translate(translation.x, translation.y, translation.z); }
        ...
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(TSVector scales) { return Scale(scales.x, scales.y, scales.z); }
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(TSVector scales, TSVector centerPoint) { return Scale(scales.x, scales.y, scales.z, centerPoint); }
        ...
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(FP scale) { return Scale(scale, scale, scale); }
        ...
        /// <param name="centerPoint">The center point.</param>
        /// <returns>The scaling matrix.</returns>
        public static TSMatrix4x4 Scale(FP scale, TSVector centerPoint) { return Scale(scale, scale, scale, centerPoint); }
        ...
        public static void TRS(TSVector translation, TSQuaternion rotation, TSVector scale, out TSMatrix4x4 matrix) { matrix = Translate(translation) * Rotate(rotation) * Scale(scale); }

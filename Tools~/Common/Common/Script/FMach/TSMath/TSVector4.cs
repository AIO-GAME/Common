...
namespace AIO.FMach
{
    ...
    public struct TSVector4
    {
        ...
        public override string ToString() { return string.Format("({0:f1}, {1:f1}, {2:f1}, {3:f1})", x.AsFloat(), y.AsFloat(), z.AsFloat(), w.AsFloat()); }
        ...
        public static bool operator ==(TSVector4 value1, TSVector4 value2) { return (((value1.x == value2.x) && (value1.y == value2.y)) && (value1.z == value2.z) && (value1.w == value2.w)); }
        ...
        public bool IsZero() { return (this.sqrMagnitude == FP.Zero); }

        /// <summary>
        /// Checks if the length of the vector is nearly zero.
        /// </summary>
        /// <returns>Returns true if the vector is nearly zero, otherwise false.</returns>
        public bool IsNearlyZero() { return (this.sqrMagnitude < ZeroEpsilonSq); }
        ...
        public static FP Dot(TSVector4 vector1, TSVector4 vector2) { return Dot(ref vector1, ref vector2); }
        ...
        /// <param name="vector2">The second vector.</param>
        /// <returns>Returns the dot product of both vectors.</returns>
        public static FP Dot(ref TSVector4 vector1, ref TSVector4 vector2) { return ((vector1.x * vector2.x) + (vector1.y * vector2.y)) + (vector1.z * vector2.z) + (vector1.w * vector2.w); }
        ...
        public static FP operator *(TSVector4 value1, TSVector4 value2) { return Dot(ref value1, ref value2); }
        ...
        public TSVector2 ToTSVector2() { return new TSVector2(this.x, this.y); }

        public TSVector ToTSVector() { return new TSVector(this.x, this.y, this.z); }
    }
}
...
namespace AIO
{
    public partial class AHelper
    {
        ...
        public partial class IO
        {
            ...
            public static async Task<string> ReadUTF8Async(string path) => await ReadTextAsync(path, "utf-8");

            /// <summary>
            /// 异步 按照UTF-8读取文本文件
            /// </summary>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static async Task<string> ReadUTF8Async(FileInfo path) => await ReadTextAsync(path.FullName, "utf-8");
            ...
            /// <param name="concat">[Ture : 追加] [False : 覆盖]</param>
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static async Task<bool> WriteUTF8Async(FileInfo path, string text, bool concat = false)
            {
                return await WriteTextAsync(path.FullName, text, "utf-8", concat);
            }

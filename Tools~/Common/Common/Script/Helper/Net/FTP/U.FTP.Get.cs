...
public partial class AHelper
{
    public partial class Net
    {
        public partial class FTP
        {
            ...
            /// <returns></returns>
            public static string GetMD5(string uri, string user, string pass, ushort timeout = TIMEOUT)
            {
                try
                {
            ...
            /// <param name="timeout"></param>
            /// <returns></returns>
            public static async Task<string> GetMD5Async(string uri, string user, string pass, ushort timeout = TIMEOUT)
            {
                try
                {
                    var request = CreateRequestFile(uri, user, pass, "RETR", timeout);

...
public partial class AHelper
{
    public partial class Net
    {
        public partial class FTP
        {
            ...
            /// <param name="timeout">超时</param>
            /// <param name="bufferSize">缓存大小</param>
            public static void UploadFolder(string uri, string username, string password,
                string localPath,
                string remotePath,
                ProgressArgs progress = default,
            ...
            )
            {
                ...
                foreach (var fileInfo in fileInfos)
                {
                    ...
                    var request =
                        (FtpWebRequest)WebRequest.Create(new Uri(Path.Combine(uri, remotePath, relativePath)));

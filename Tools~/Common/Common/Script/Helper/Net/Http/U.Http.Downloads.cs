...
public partial class AHelper
{
    public partial class Net
    {
        ...
        /// HTTP 下载文件
        /// </summary>
        /// <param name="remotePaths">远端路径</param>
        ...
        public static async Task HTTPDownloadAsync(IEnumerable<string> remotePaths, string localPath,
        ...
        /// <param name="bufferSize">容量</param>
        /// <exception cref="Exception">异常</exception>
        public static void HTTPDownload(IEnumerable<string> remotePaths, string localPath,
            ProgressArgs progress = default,
            bool isOverWrite = false,
            ushort timeout = TIMEOUT,
            int bufferSize = BUFFER_SIZE

namespace AIO.Net
{
    ...
    public class HttpSession : TcpSession
    {
        ...
        {
            return this.Send(response.Cache.Arrays, response.Cache.Offset, response.Cache.Count);
        }
        ...
        /// <returns>Size of sent data</returns>
        public long SendResponseBody(byte[] buffer, int offset, int size)
        {
            return this.Send(buffer, offset, size);
        }
        ...
        {
            return this.SendAsync(response.Cache.Arrays, response.Cache.Offset, response.Cache.Count);
        }
        ...
        /// <param name="size">HTTP response body size</param>
        /// <returns>'true' if the HTTP response body was successfully sent, 'false' if the session is not connected</returns>
        public bool SendResponseBodyAsync(byte[] buffer, int offset, int size)
        {
            return this.SendAsync(buffer, offset, size);
        }

...
namespace AIO.Net
{
    ...
    public class UdpServer : IDisposable
    {
        ...
        public virtual bool SendAsync(EndPoint endpoint, byte[] buffer)
        {
            ...
            if (((_sendBuffer.Count + buffer.Length) > OptionSendBufferLimit) && (OptionSendBufferLimit > 0))
            {
            ...
            // Update statistic
            BytesSending = _sendBuffer.Count;
        ...
        public virtual bool SendAsync(EndPoint endpoint, string text) =>
            SendAsync(endpoint, Encoding.UTF8.GetBytes(text));
        ...
        private void TryReceive()
        {
            ...
            try
            {
                ...
                _receiveEventArg.SetBuffer(_receiveBuffer.Arrays, 0, _receiveBuffer.Capacity);
        ...
        private void TrySend()
        {
            ...
            try
            {
                ...
                _sendEventArg.SetBuffer(_sendBuffer.Arrays, 0, _sendBuffer.Count);
        ...
        private void ProcessReceiveFrom(SocketAsyncEventArgs e)
        {
            ...
            // Call the datagram received handler
            OnReceived(e.RemoteEndPoint, _receiveBuffer.Arrays, 0, size);

...
public static class UnityConsole
{
    ...
    /// </summary>
    public static void ENABLED_ALL()
    {
        ENABLED_LOG();
        ENABLED_ERROR();
    }
    ...
    /// 关闭 LOG 输出
    /// </summary>
    public static void ENABLED_LOG()
    {
        if (WriterOut == null)
        {
    ...
    /// 关闭 ERROR 输出
    /// </summary>
    public static void ENABLED_ERROR()
    {
        if (WriterError == null)
        {
    ...
    /// 关闭 LOG 输出
    /// </summary>
    public static void DISABLE_LOG()
    {
        if (WriterOut != null)
        {
    ...
    /// 关闭 ERROR 输出
    /// </summary>
    public static void DISABLE_ERROR()
    {
        if (WriterError != null)
        {
    ...
    private class UnityTextWriter : TextWriter
    {
        ...
        public void SetPrint(bool value)
        {
            IsPrint = value;

...
namespace DG.Tweening
{
	...
	public class DOTween
	{
		...
		private static IDOTweenInit Init(DOTweenSettings settings, bool? recycleAllByDefault, bool? useSafeMode, LogBehaviour? logBehaviour)
		{
			...
			{
				Debugger.Log(string.Concat("DOTween initialization (useSafeMode: ", DOTween.useSafeMode.ToString(), ", recycling: ", defaultRecyclable ? "ON" : "OFF", ", logBehaviour: ", DOTween.logBehaviour.ToString(), ")"));
			}
			return instance;
		}

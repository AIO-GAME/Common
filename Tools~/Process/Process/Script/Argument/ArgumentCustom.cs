...
namespace AIO
{
    ...
    public abstract class ArgumentCustom
    {
        ...
        {
            return Argument.GetBool(command, key);
        }
        ...
        {
            return Argument.GetString(command, key);
        }
        ...
        {
            return Argument.GetStringArray(command, key);
        }
        ...
        {
            return Argument.GetEnum(command, type, key);
        }
        ...
        {
            return Argument.GetIntegerArray(command, key);
        }
        ...
        {
            return Argument.GetInteger(command, key);
        }
    }
}

...
namespace AIO
{
    ...
    {
        private const string CMD_STR_UploadFile = "cp \"{0}\" \"gs://{1}\"";
        ...
        public static bool UploadFile(string remote, string location, Action<string> onProgress)
        {
        ...
        /// <returns> Ture:成功 False: 失败 </returns>
        [DebuggerHidden, DebuggerNonUserCode]
        public static Task<bool> UploadFileAsync(string remote, string location, IDictionary<string, string> metadata)
        {
            return UploadFileAsync(remote, location, metadata, Console.WriteLine);
        }
        ...
        {
            if (string.IsNullOrEmpty(key) || string.IsNullOrEmpty(value))
                return UploadFileAsync(remote, location, onProgress);
            var metadata = new Dictionary<string, string> { { key, value } };
            return UploadFileAsync(remote, location, metadata, onProgress);
        }
        ...
        /// <returns> Ture:成功 False: 失败 </returns>
        [DebuggerHidden, DebuggerNonUserCode]
        public static Task<bool> UploadFileAsync(string remote, string location)
        {
            return UploadFileAsync(remote, location, Console.WriteLine);
        }
        ...
        public static bool UploadFile(string remote, string location)
        {
            return UploadFile(remote, location, Console.WriteLine);
        }
        ...
        /// <returns> Ture:成功 False: 失败 </returns>
        [DebuggerHidden, DebuggerNonUserCode]
        public static bool UploadFile(string remote, string location, IDictionary<string, string> metadata)
        {
            return UploadFile(remote, location, metadata, Console.WriteLine);
        }
        ...
        {
            if (string.IsNullOrEmpty(key) || string.IsNullOrEmpty(value))
                return UploadFile(remote, location, onProgress);
            var metadata = new Dictionary<string, string> { { key, value } };
            return UploadFile(remote, location, metadata, onProgress);
        }
    }
}
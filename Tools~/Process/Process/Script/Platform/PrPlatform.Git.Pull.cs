...
namespace AIO
{
    public partial class PrPlatform
    {
        public partial class Git
        {
            ...
            public static IExecutor PullBranch(ICollection<string> targets, bool quit = false)
            {
                switch (Environment.OSVersion.Platform)
                {
                    ...
                    case PlatformID.WinCE:
                        return PrWin.Git.PullBranch(targets, quit);
                    case PlatformID.MacOSX:
                    case PlatformID.Unix:
                        return PrMac.Git.PullBranch(targets, quit);

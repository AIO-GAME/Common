...
namespace AIO
{
    ...
    internal static class Helper
    {
            ...
            where T : Object
        {
            ...
            return UnityEditor.AssetDatabase.FindAssets(pattern, folder)
        ...
        public class CompilationPipeline
        {
            ...
            public static void compilationStarted()
            {
                ...
                var methodInfo = typeof(Helper).GetMethod(nameof(compilationStarted), BindingFlags.Static | BindingFlags.NonPublic);
            ...
            private static void compilationStarted(object o)
            {
                ...
                {
                    var methodInfo = typeof(Helper).GetMethod(nameof(compilationFinished), BindingFlags.Static | BindingFlags.NonPublic);
                    if (methodInfo is null) return;

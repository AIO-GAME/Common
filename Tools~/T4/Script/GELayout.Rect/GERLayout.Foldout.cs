...
namespace AIO
{
    public partial class GERLayoutSingleton
    {
        ...
        private static List<FunctionChunk> FoldoutHeaderGroup()
        {
            ...
            {
                new[] { rect, label, foldout, action },
                new[] { rect, label, foldout, action, style },
                new[] { rect, label, foldout, action, style, menuAction },
                new[] { rect, label, foldout, action, style, menuAction, menuIcon }
            })
            {
            ...
            foreach (var param in new[]
            {
                new[] { rect, label, foldout },
                new[] { rect, label, foldout, style },
                new[] { rect, label, foldout, style, menuAction },
                new[] { rect, label, foldout, style, menuAction, menuIcon }
            })
            {
                var chunk = new FunctionChunk
                {

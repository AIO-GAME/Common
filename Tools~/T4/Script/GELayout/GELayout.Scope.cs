...
namespace AIO
{
    public partial class GELayoutSingleton
    {
        ...
        private static List<FunctionChunk> Horizontal()
        {
            ...
            {
                new[] { action, Options },
                new[] { action, width_float },
                new[] { action, width_float, height_float },
                new[] { action, Style, Options },
                new[] { action, Style, width_float },
                new[] { action, Style, width_float, height_float }
            };
        ...
        private static List<FunctionChunk> GroupBuildTargetSelection()
        {
            ...
            }
            {
                var chunk = new FunctionChunk
                {
                    ...
                    Comments        = "绘制 开始构建目标分组",
                    Name            = $"A{Name}",
                    Params          = new[] { value, new FunctionParam("BuildTargetGroup", "value") },
                    MacroDefinition = "UNITY_2019_1_OR_NEWER",

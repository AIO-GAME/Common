...
namespace AIO
{
    public partial class GULayoutSingleton
    {
        ...
        private static List<FunctionChunk> Horizontal()
        {
            ...
            {
                new[] { value, Options },
                new[] { value, width_float },
                new[] { value, width_float, height_float },
                new[] { value, Style, Options },
                new[] { value, Style, width_float },
                new[] { value, Style, width_float, height_float }
            };
            ...
            {
                new[] { width_float },
                new[] { width_float, height_float },
                new[] { Options },
                new[] { Style, Options },
                new[] { Style, width_float },
                new[] { Style, width_float, height_float }
            };
            foreach (var param in paramsList)
            {
                var chunk = new FunctionChunk
        ...
        private static List<FunctionChunk> ScrollView()
        {
            ...
            var paramsList = new List<FunctionParam[]>
            {
                new[] { value, v2, Options },
                new[] { value, v2, width_float },
                new[] { value, v2, width_float, height_float },
                new[] { value, v2, Options },
                new[] { value, v2, width_float },
                new[] { value, v2, width_float, height_float },
                new[] { value, v2, alwaysShowHorizontal, alwaysShowVertical, Options },
                new[] { value, v2, styles_h, styles_v, Options },
                new[]
            ...
            paramsList = new List<FunctionParam[]>
            {
                new[] { v2, Options },
                new[] { v2, width_float },
                new[] { v2, width_float, height_float },
                new[] { v2, Options },
                new[] { v2, width_float },
                new[] { v2, width_float, height_float },
                new[] { v2, alwaysShowHorizontal, alwaysShowVertical, Options },
                new[] { v2, styles_h, styles_v, Options },
                new[]
        ...
        private static List<FunctionChunk> Scroll()
        {
            ...
            var paramsList = new List<FunctionParam[]>
            {
                new[] { value, rect, v2, viewRect },
                new[] { value, rect, v2, viewRect, alwaysShowHorizontal, alwaysShowVertical },
                new[] { value, rect, v2, viewRect, styles_h, styles_v },
                new[]
            ...
            paramsList = new List<FunctionParam[]>
            {
                new[] { rect, v2, viewRect },
                new[] { rect, v2, viewRect, alwaysShowHorizontal, alwaysShowVertical },
                new[] { rect, v2, viewRect, styles_h, styles_v },
                new[]
        ...
        private static List<FunctionChunk> Area()
        {
            ...
            foreach (var item in new[] { "string", "GUIContent", "Texture" })
            {
                ...
                {
                    new[] { value, rect },
                    new[] { value, rect, label },
                    new[] { value, rect, label, Style },
                    new[] { value, rect, Style }
                };
                foreach (var param in paramsList)
                {
                    var chunk = new FunctionChunk
        ...
        private static List<FunctionChunk> Clip()
        {
            ...
            {
                new[] { value, rect },
                new[] { value, rect, scrollOffset, renderOffset, resetOffset },
                new[] { value, rect, rectOffset, resetOffset }
            };
            ...
            {
                new[] { rect },
                new[] { rect, scrollOffset, renderOffset, resetOffset },
                new[] { rect, rectOffset, resetOffset }
            };
            foreach (var param in paramsList)
            {
                var chunk = new FunctionChunk

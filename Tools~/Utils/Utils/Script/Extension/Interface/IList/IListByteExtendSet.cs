...
namespace AIO
{
    ...
    public static partial class ByteExtend
    {
        ...
        /// <typeparam name="T"></typeparam>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetJson<T>(this IList<byte> array, ref int index, in T value, in Encoding encoding = null, in bool reverse = false)
        {
            var data = ParseUtils.JsonSerialize(value);
            SetString(array, ref index, data, encoding, reverse);
        }
        ...
        /// <typeparam name="T"></typeparam>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetJsonUTF8<T>(this IList<byte> array, ref int index, in T value, in bool reverse = false)
        {
            var data = ParseUtils.JsonSerialize(value);
            SetString(array, ref index, data, Encoding.UTF8, reverse);
        }
        ...
        /// <typeparam name="T"></typeparam>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetJsonASCII<T>(this IList<byte> array, ref int index, in T value, in bool reverse = false)
        {
            var data = ParseUtils.JsonSerialize(value);
            SetString(array, ref index, data, Encoding.ASCII, reverse);
        }
        ...
        /// <typeparam name="T"></typeparam>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void SetJsonUnicode<T>(this IList<byte> array, ref int index, in T value, in bool reverse = false)
        {
            var data = ParseUtils.JsonSerialize(value);
            SetString(array, ref index, data, Encoding.Unicode, reverse);
        }

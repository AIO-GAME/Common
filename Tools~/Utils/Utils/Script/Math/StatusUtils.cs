...
namespace AIO
{
    ...
    /// 状态值比较
    /// </summary>
    public static partial class StatusUtils
    {
        /// <summary>
        /// 2次幂运算 判断是否相等
        /// </summary>
    ...
    public static partial class StatusUtils
    {
        ...
        /// <param name="status">操作状态</param>
        /// <returns>新状态</returns>
        [Obsolete("已过时:不推荐使用 原因:性能耗时与值类型相比 差距为上千倍 推荐使用int值")]
        public static T Del<T>(in T source, in T status) where T : IComparable, IComparable<T>, IConvertible, IEquatable<T>
        {

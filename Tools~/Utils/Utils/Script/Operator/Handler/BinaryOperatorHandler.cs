...
namespace AIO
{
    ...
    {
        /// <inheritdoc />
        protected BinaryOperatorHandler(in string name, in string verb, in string symbol, in string customMethodName)
        ...
        public virtual object Operate(object leftOperand, object rightOperand)
        {
            ...
            if (customMethodName != null)
            {
                ...
                {
                    leftOperand = ConversionUtils.Convert(leftOperand, userDefinedOperandTypes[query].leftType);
                    rightOperand = ConversionUtils.Convert(rightOperand, userDefinedOperandTypes[query].rightType);
        ...
        private readonly struct OperatorQuery : IEquatable<OperatorQuery>
        {
            ...
            {
                return HashUtils.GetHashCode(leftType, rightType);
            }
        }
    }
}
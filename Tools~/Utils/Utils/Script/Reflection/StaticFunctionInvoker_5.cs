...
namespace AIO
{
    public sealed class StaticFunctionInvoker<TParam0, TParam1, TParam2, TParam3, TParam4, TResult> : StaticFunctionInvokerBase<TResult>
    {
        ...
        public override object Invoke(in object target, params object[] args)
        {
            if (args.Length != 5)
            {
        ...
        public override object Invoke(in object target, in object arg0, in object arg1, in object arg2, in object arg3, in object arg4)
        {
        ...
        public object InvokeUnsafe(in object target, in object arg0, in object arg1, in object arg2, in object arg3, in object arg4)
        {
        ...
        protected override void CreateDelegate()
        {
            invoke = (param0, param1, param2, param3, param4) =>
                ((Func<TParam0, TParam1, TParam2, TParam3, TParam4, TResult>)methodInfo.CreateDelegate(typeof(Func<TParam0, TParam1, TParam2, TParam3, TParam4, TResult>)))(param0, param1, param2,
                    param3, param4);
        }
    }
}
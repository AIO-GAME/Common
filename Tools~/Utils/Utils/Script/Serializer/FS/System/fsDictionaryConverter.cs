...
namespace AIO
{
    public class fsDictionaryConverter : fsConverter
    {
        ...
        public override fsResult TryDeserialize(in fsData data, ref object instance_, in Type storageType)
        {
        ...
        public override fsResult TrySerialize(in object instance_, out fsData serialized, in Type storageType)
        {
        ...
        private fsResult AddItemToDictionary(in IDictionary dictionary, in object key, in object value)
        {

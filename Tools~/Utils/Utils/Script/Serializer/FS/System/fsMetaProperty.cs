...
namespace AIO
{
    ...
    {
        internal fsMetaProperty(in fsConfig config, in FieldInfo field)
        {
            _memberInfo = field;
        ...
        internal fsMetaProperty(in fsConfig config, in PropertyInfo property)
        {
        ...
        private void CommonInitialize(in fsConfig config)
        {
        ...
        /// </summary>
        public void Write(in object context, in object value)
        {
        ...
        /// </summary>
        public object Read(in object context)
        {

namespace AIO
{
    ...
    public abstract class fsObjectProcessor
    {
        ...
        /// </returns>
        public virtual bool CanProcess(in Type type)
        {
        ...
        public virtual void OnBeforeSerialize(in Type storageType, in object instance) { }
        ...
        public virtual void OnAfterSerialize(in Type storageType, in object instance, ref fsData data) { }
        ...
        /// </param>
        public virtual void OnBeforeDeserialize(in Type storageType, ref fsData data) { }
        ...
        /// The data that will be used for deserialization.
        /// </param>
        public virtual void OnBeforeDeserializeAfterInstanceCreation(in Type storageType, in object instance, ref fsData data) { }
        ...
        /// </param>
        /// <param name="instance">The type of the instance.</param>
        public virtual void OnAfterDeserialize(in Type storageType, in object instance) { }
    }
}

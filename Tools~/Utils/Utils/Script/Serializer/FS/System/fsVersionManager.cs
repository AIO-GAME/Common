namespace AIO
{
    ...
    public static class fsVersionManager
    {
        ...
        /// 导入路径
        /// </summary>
        public static fsResult GetVersionImportPath(in string currentVersion, in fsVersionedType targetVersion, out List<fsVersionedType> path)
        {
        ...
        private static bool GetVersionImportPathRecursive(in List<fsVersionedType> path, in string currentVersion, in fsVersionedType current)
        {
        ...
        public static fsOption<fsVersionedType> GetVersionedType(in Type type)
        {
        ...
        /// ancestor types.
        /// </summary>
        private static void VerifyConstructors(in fsVersionedType type)
        {
        ...
        /// </summary>
        private static void VerifyUniqueVersionStrings(in fsVersionedType type)
        {

...
namespace AIO
{
    ...
    {
        public StaticFunctionInvoker(in MethodInfo methodInfo) : base(methodInfo)
        {
        }
        ...
        public override object Invoke(in object target, in object arg0, in object arg1, in object arg2, in object arg3)
        {
        ...
        protected override void CreateDelegate()
        {
            invoke = (param0, param1, param2, param3) =>
                ((Func<TParam0, TParam1, TParam2, TParam3, TResult>)methodInfo.CreateDelegate(typeof(Func<TParam0, TParam1, TParam2, TParam3, TResult>)))(param0, param1, param2, param3);
        }
    }
}